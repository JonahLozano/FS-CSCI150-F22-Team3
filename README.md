...
- GOOGLE_CLIENT_ID & GOOGLE_CLIENT_SECRET will be what is assigned after signing up for Google API https://console.cloud.google.com/apis/credentials/oauthclient the Authorized redirect URIs: http://localhost:5000/register/google/callback
- PORT can be any port, we can use 5000 for this
